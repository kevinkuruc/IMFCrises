...
horizons = zeros(7)
horizons[2] = mean(convert(Array, Treated_F1[:PostGrowth1]-Synthetics_F1[:PostGrowth1]))
horizons[3] = mean(convert(Array, Treated_F2[:PostGrowth2]-Synthetics_F2[:PostGrowth2]))
horizons[4] = mean(convert(Array, Treated_F3[:PostGrowth3]-Synthetics_F3[:PostGrowth3]))
